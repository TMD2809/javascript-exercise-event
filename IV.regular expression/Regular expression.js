...
//|| negative pattern
/[^a-z]/.test("domain"); // false: anchor of [a-z] mean all the string was input are not include a-z, ^ in this case is negative pattern
...
//* get four digit character {n}
console.log(str1.match(/\d{4}/)[0]);

//* get from four to six character {n,m}
console.log(str1.match(/\d{4,6}/)[0]);

//* get all character meet the condition
console.log(str1.match(/\d+/)[0]);

//* '?':u' has or not in color

//* flag:
// g:global | i:case insensitive | m: multi lines | *: The n* quantifier matches any string that contains zero or more occurrences of n.
...
//|| Boundaries
// \b: Find a match a word that stand alone, beginning like this: \bHI, end like this: HI\b
"domain expansion".match(/\bdomain/g); // domain
"my name isSherlock".match(/\BSherlock/g); // Sherlock
...
"welcome 1234567".match(/\d+/g); //! ["1234567"], '+' mean get more than one item
